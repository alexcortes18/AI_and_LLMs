...
def get_save_path(folder_name):
    return str(PROJECT_ROOT / folder_name)
...
class ModelTrainer:
    def __init__(self):
        ...
        self.output_dir = get_save_path("checkpoints/train_and_chat_sentiment")
...
class ModelInterface:
    def __init__(self):
        ...
        self.model_checkpoint = "distilbert-base-uncased"
        self.final_model_dir = Path(get_save_path("lora-sentiment-improved"))
    ...
    def load_models(self):
        try:
            ...
            if self.final_model_dir.exists():
                ...
                self.sentiment_model = PeftModel.from_pretrained(
                    base_model_sentiment, str(self.final_model_dir)
                )
